...
xterm -e "roslaunch start_robot_r_2dx.launch" &
sleep 2
xterm -e "roslaunch start_robot_b_2dx.launch" &
sleep 2
xterm -e "roslaunch start_robot_g_2dx.launch" &
sleep 2
xterm -e "roslaunch start_robot_y_2dx.launch" &
sleep 2
