...
xterm -e "roslaunch start_robot_r_crwl.launch" &
sleep 2
xterm -e "roslaunch start_robot_b_crwl.launch" &
sleep 2
xterm -e "roslaunch start_robot_g_crwl.launch" &
sleep 2
xterm -e "roslaunch start_robot_y_crwl.launch" &
sleep 2
